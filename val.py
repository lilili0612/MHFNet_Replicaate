...
if __name__ == '__main__':
    ...
    # model = YOLO("runs/train2/YOLOv8n-vsff22/weights/best.pt")
    ...
    #qxs_rgb
    model = YOLO("runs/train2/YOLOv8n-RGB_single2/weights/best.pt")
    metrics = model.val(data="qxs_rgb.yaml", #"D:/YOLO-MIF-master/data-vsff2.yaml",
              ...
              save_json=True,  # if you need to cal coco metrice
              project='runs/val2',
              name='YOLOv8n-RGB_single2',
              )

    # #qxs_sar
    # model = YOLO("runs/train2/YOLOv8n-SAR_single2/weights/best.pt")
